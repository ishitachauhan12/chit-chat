...
export default function Sidebar( {user, page }) {
  ...
  function createRoom() {
    ...
    if (roomName!==null && roomName.length!==0 && roomName.trim) {
  ...
  async function searchUsersAndRoom(event){
  ...
  return (
    ...
    >
      ...
      <div className="sidebar__search">
        <form onSubmit={searchUsersAndRoom} className="sidebar__search--container">
          <SearchOutlined />
          <input
